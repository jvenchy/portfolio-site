    ...
    <section className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-green-100 to-blue-100">
      ...
      {selectedExperience && (
        <div 
          ...
          className="fixed inset-0 z-50 flex items-center justify-center text-black bg-black bg-opacity-50 transition-opacity duration-500 ease-in-out">
          
          <div 
            onClick={(e) => e.stopPropagation()}
            className="bg-gradient-to-r from-green-400 to-blue-400 text-white font-mono rounded-lg shadow-lg p-6 w-full max-w-md w-full max-w-md transition-transform duration-500 ease-in-out transform scale-95">
