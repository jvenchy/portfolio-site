...
// <h2 className="text-8xl text-theme font-bold mb-4">Projects</h2>
...
const projects: Project[] = [
  ...
  },
  {
    ...
    githubLink: "https://github.com/jvenchy/recipe-finder",
  },
  {
    id: 5,
    ...
    year: "2024",
    description: "Hackathon Project. See https://devpost.com/software/eventuary",
...
const ProjectPopup: React.FC<{ project: Project; onClose: () => void }> = ({ project, onClose }) => (
  <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
    <div onClick={(e) => e.stopPropagation()} className="bg-gradient-to-r from-green-400 to-blue-400 text-white font-mono rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <button
              onClick={() => onClose()}
